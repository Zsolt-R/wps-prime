<?php
/**
 * wps_prime functions and definitions
 *
 * @package wps_prime
 */
...
function wps_prime_setup() {
	...
	// Source: http://stackoverflow.com/questions/18944027/how-do-i-defer-or-async-this-wordpress-javascript-snippet-to-load-lastly-for-fas
	///////////////////////////////////////////////////////////////////////////////////////////////
...
function wps_prime_scripts() {
	...
	wp_enqueue_script( 'picturefill_core', get_template_directory_uri() . '/js/min/picturefill.min.js#deferload', array(), '2.1.0', true );
...
function add_main_css(){
    wp_enqueue_style( 'wps_prime-icon-fonts', get_template_directory_uri() .'/css/fonts/iconfont/font-awesome-4.4.0/css/font-awesome.min.css' );
}
