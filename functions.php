...
class WPS_Theme_Setup
{
    ...
    public static function theme_meta_boxes() 
    {
        ...
        include_once WPS_ENGINE_DIR .'/meta-fields/page-title-visibility.php';
    ...
    public function theme_options() 
    {
        ...
        include_once WPS_ENGINE_DIR .'/theme-options-framework/options-framework.php';
    ...
    public function wps_theme_base() 
    {
        ...
        include WPS_ENGINE_DIR .'/theme-functions/theme-admin-favicon.php';
