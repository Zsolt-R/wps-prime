...
/* Product Template Files Hook */

function product_entry_content_media_img(){
    do_action('product_entry_content_media_img');
}

function product_entry_content_media_body(){
    do_action('product_entry_content_media_body');
}

function product_entry_footer(){
    do_action('product_entry_footer');
}
