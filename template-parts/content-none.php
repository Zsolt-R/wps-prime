...
<section class="no-results not-found">
    ...
    <div class="page-content">
		<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
			...
			<p><?php printf( wp_kses( __( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'wps-prime' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( admin_url( 'post-new.php' ) ) ); ?></p>
