 ...
 * Register & extend addon icon font family for VC ( woothemes-e-commerce-icons )
 *
 * @since 1.4.4
 */
...
require get_template_directory() . '/inc/integrations/visual-composer/params/wps-extend-vc-icons.php'; // Add extra icons
...
add_action( 'vc_after_init', 'wps_vc_icon_shortcode' );
...
function wps_vc_admin_style(){
  ...
  if ( get_post_meta(get_the_ID(), '_wpb_vc_js_status', true) && isset( $_GET['action'] ) ) {   
    if('edit' === $_GET['action']){
        ...
        wp_register_style( 'wps_prime-woo-ecom-admin-child', get_template_directory_uri() .'/css/icons/wps-woothemes-e-commerce-icons/woothemes_ecommerce.css' );
