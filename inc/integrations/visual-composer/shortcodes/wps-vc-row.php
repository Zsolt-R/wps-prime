...
function wps_vc_row_shortcode() {
	...
	$attributes = array(
		...
		array(
			'type'        => 'dropdown',
			'heading'     => 'Wrapper size',
			'param_name'  => 'wrapper_size',
			'admin_label' => true,
			'value'       => wps_wrapper_size(),
			'std'         => '',
			'description' => __( 'Adjust the width of the wrapper, only works if wrapper is enabled', 'wps-prime' ),
		),
