 ...
 */
$class         = $wrapper = $wrapper_class = $wrapper_size = $holder_img = $holder_class = $holder_id = $holder_img_size = $holder_img_behave = $holder_img_pos = $use_parallax = '';
...
if ( $has_tube_bg || $has_hosted_bg ) {
	...
	$class = wps_getExtraClass(
		array(
			...
			$grid_col_full_height ? wps_getExtraClass( 'grid--full-height' ) : '',
		)
	);
	...
	// Wrapper Classes
	$class_w = wps_getExtraClass( array( 'o-wrapper', $wrapper_size, $wrapper_class ), true );
