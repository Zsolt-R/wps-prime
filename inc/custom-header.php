 ...
 *
 * @uses wps_prime_header_style()
 * @uses wps_prime_admin_header_style()
 * @uses wps_prime_admin_header_image()
 */
function wps_prime_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'wps_prime_custom_header_args', array(
		'default-image'          => '',
		'default-text-color'     => '000000',
		'width'                  => 1000,
		'height'                 => 250,
		'flex-height'            => true,
		'wp-head-callback'       => 'wps_prime_header_style',
		'admin-head-callback'    => 'wps_prime_admin_header_style',
		'admin-preview-callback' => 'wps_prime_admin_header_image',
	) ) );
}
