...
function tgm_php_mysql_versions() {
	...
	echo '<p>You are running on <strong>PHP ' . phpversion() . '</strong> and <strong>MySQL ' . $wpdb->db_version() . '</strong>.</p><p>WordPress version - '. get_bloginfo( 'version' ) .'<br/>Current theme - '. $theme->get( 'Name' ) . " version " . $theme->get( 'Version' ) .'</p>';
}
